...
# Page Configuration
st.set_page_config(page_title="AI-Powered Revenue Leakage Detection", page_icon="🔍", layout="wide")
...
# File uploader
uploaded_file = st.file_uploader("📂 Upload your financial transactions CSV file", type=["csv"], help="Ensure your file has correct financial transaction data")
...
if uploaded_file is not None:
    ...
    if response.status_code == 200:
        ...
        if anomalies:
            ...
            fig = px.histogram(anomalies_df, x="Amount", nbins=50, title="Anomalous Transaction Amounts", color_discrete_sequence=["#17a2b8"])
